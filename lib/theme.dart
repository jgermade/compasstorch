...
class AppColors {
  ...
  /// Azul del faro en la barra de estado: más claro que el acento, para que el
  /// icono se distinga del de la linterna de un vistazo.
  static const Color beaconLight = Color(0xFF4DD0E1);
